public class Task {
  public static void main(String[] args) {
    ...
    System.out.println("Номер животного - " + vorobey.getCount());
    System.out.println(vorobey.toString());
    Insect zhora = new Insect();
    System.out.println("Общее количество животных - " + Animal.count);
    System.out.println("Номер животного - " + zhora.getCount());
...
class Animal {
  ...
  static int count =0;
  static public int increaseCount()
  {
    return ++count;
  }
  {
  ...
  {
    return "Тип: " + type + ", Имя: " + name + ", Возраст: " + age + ", Вес: " + this.weight + "   Умеет летать: " + (isFly?"Да":"Нет") + ", Умеет ходить: "+ (isWalk?"Да":"Нет") + ", Умеет плавать: " + (isSwim?"Да":"Нет") + "." + "\n" + "Номер животного " + count;
  }
  final private static String description = "Общий класс животного";
  public void display()
  {
  ...
  final public void rename(String new_name)
  {
    this.name = new_name;
  }
...
class Bird extends Animal {
  ...
  public Bird (String type, String name, int age, double weight, boolean isSwim, boolean isFly, boolean isWalk)
  {
    super(type,name,age, weight,isSwim,isFly,isWalk);
    count++;
  }
  @Override
  public String toString()
  {
    return "Тип: " + getType() + ", Имя: " +getName() + ", Возраст: " + getAge() + ", Вес: " + getWeight() + "   Умеет летать: " + (isFly()?"Да":"Нет") + ", Умеет ходить: "+ (isWalk()?"Да":"Нет") + ", Умеет плавать: " + (isSwimm()?"Да":"Нет") + "." + "\n" + "Номер животного " + count;
  }

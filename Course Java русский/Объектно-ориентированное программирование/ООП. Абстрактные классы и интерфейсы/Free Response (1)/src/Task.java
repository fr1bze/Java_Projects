public class Task {
  public static void main(String[] args) {
    ...
    house.setBuildYear(1975);
    house.makeReconstruction();
    house.NewFamily(2);
...
class House extends Building implements LivingHouse {
  ...
  public void makeReconstruction() {
    if (getBuildYear() <2000)
      System.out.println("Need reconstruction");
  }

  @Override
  public void NewFamily() {
    System.out.println("Заехала новая семья");
  }
  @Override
  public void NewFamily(int n) {
    System.out.println("Заехала новая семья из " + n + " человек");
  }
...
class HighRiseBuilding extends Building implements LivingHouse {
  ...
  @Override
  public void NewFamily(int n) {
    System.out.println("Заехало новый семей: " + n);
  }
  @Override
  public void NewFamily() {
    System.out.println("Заехала новая семья");

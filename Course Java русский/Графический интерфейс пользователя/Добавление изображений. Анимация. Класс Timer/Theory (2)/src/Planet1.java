...
public class Planet1 extends Thread {
    ...
    public static class CreatePlanet {//класс для создания планеты
        ...
        public CreatePlanet(String path, int r) throws IOException {//конструктор
            this.path = path;
            this.r=r;
            BufferedImage im = ImageIO.read(new File("/Users/mikhail/Desktop/Java_Projects/planets/planets_phot/" + path));//открываем картинку
    ...
    public static void main(String[] args) throws IOException {
        ...
        frame.setTitle("Solar System");//заголовок формы
        ...
        new CreatePlanet("sun.jpeg", 0);//создаем солнце
        ...
        for (int i = 0; i < planets.length; i++)//в цикле запускаем планеты
            new RunPlanet(new CreatePlanet(planets[i][0] + ".jpeg", Integer.valueOf(planets[i][1])), Integer.valueOf(planets[i][2])).start();
    }
}
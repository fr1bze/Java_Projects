...
public class Main {
    ...
    public static class SimpleSendable<T> implements Message<T> {
    ...
    public static class Salary extends SimpleSendable<Integer> {
        ...
        public MailService() {
            mailBox = new MyHashMap<String, List<T>>();
        }

            @Override
            public void accept(Message<T> o) {
                mailBox.computeIfAbsent(o.getTo(), k -> new LinkedList<>()).add(o.getContent());
            }
